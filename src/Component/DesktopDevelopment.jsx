...
import SwitchCaseBackend from './DesktopDevelopmentShowBackend.jsx';
import SwitchCaseFrontend from './DesktopDevelopmentShowFrontend.jsx';
import SwitchCaseFullStrack from './DesktopdevelopmentShowDatabase.jsx';
        ...
        <div className="WebDevelopment" >
            ...
            <div className="WebDevelopment__contants">
                <div className="WebDeveloopment__Header">
                    ...
                    <Button   variant="contained" color="primary"onClick={FullStrackFunction}>FullStrack</Button>
                </div>
