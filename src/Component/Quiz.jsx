        ...
        <div className="databaseQuizw">
          ...
          <div className="frtQuize">
            <div className="htmlQuize">
              ...
              <NavLink to="mysql">
                {" "}
                <QuizeCard name="MySql" />
              </NavLink>
              <NavLink to="mongo">
                <QuizeCard name="Mongo" />
              </NavLink>
            </div>
          </div>
        </div>
